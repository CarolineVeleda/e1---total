...
<h1 style="color:white;" class="textocentro fundocor">Cadastro</h1>
...
<form action="php/cadastraUsuarios.php" method="post">
    ...
    <h1 class="text-center" style="color:white;">Nome Completo</h1>
    ...
    <br>
    <br>
    <h1 class="text-center" style="color:white;">Email</h1>
    <div class="input-group input-group-lg">
        <span>
            <button style="border-radius: 20px;" type="button" class="btn btn-dark">
    ...
    <br>
    <br>
    <h1 class="text-center" style="color:white;">Senha</h1>
    <div class="input-group input-group-lg">
        <span>
            <button style="border-radius: 20px;" type="button" class="btn btn-dark">
